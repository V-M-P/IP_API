...
/* Constans for ingatlanpont API communication */

DEFINE("INGATLANPONT_API_URL_PROD", "http://ingatlan.infonet.hu/__api.ingatlanpont.com");
DEFINE("INGATLANPONT_API_URL_TEST", "https://api.test.ingatlanpont.com");

DEFINE("API_ENDPOINT_UPLOADPROPERTY", "/upload");
