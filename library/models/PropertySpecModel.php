 ...
 class PropertySpecModel
{
    ...
    /**
     * @var string Tulajdonság azonosító.
     */
    public $SpecID;
    
    /**
     * @var string Tulajdonság érték.
     */
    public $Spec;

    /**
     * Creates a new PropertySpecModel entity.
     *
     * @param string        	$SID
     * @param int|string|null 	$Spec
     */   
    function __construct($SID = "", $Spec = "")
    {
        $this->SpecID = $SID;
        $this->Spec = $Spec;
    }
