...
//include "ipModel.php";
//include "ipHelper.php";

$include_dirs = Array(
    realpath(join(DIRECTORY_SEPARATOR, array(dirname(dirname(__FILE__)), "library/common"))),
    realpath(join(DIRECTORY_SEPARATOR, array(dirname(dirname(__FILE__)), "library/models")))
